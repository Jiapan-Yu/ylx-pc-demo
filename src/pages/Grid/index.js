...
class Grid extends Component {
	...
	constructor() {
		...
		this.state = {
			gutterKey: 1,
			colCountKey: 2
		};  // don't know why these two places need to end with semi-colon
		[8, 16, 24, 32, 40, 48].forEach((value, i) => { this.gutters[i] = value; });  // don't know why these two places need to end with semi-colon
